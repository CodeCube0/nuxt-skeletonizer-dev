...
import { v as parseQuery, l as hasProtocol, n as joinURL, m as isScriptProtocol, y as withTrailingSlash, z as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
import { _ as _export_sfc, u as useHead } from './_plugin-vue_export-helper-CD6kOlAj.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-fd77f5bb><div class="max-w-520px text-center" data-v-fd77f5bb><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-fd77f5bb>${ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-fd77f5bb>${ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-fd77f5bb>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-fd77f5bb>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fd77f5bb"]]);

export { error404 as default };
//# sourceMappingURL=error-404-D4TPzI4j.mjs.map
